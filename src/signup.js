...
function Signup(){
    ...
    let validateform=function(){
        ...
        let con_pswd = document.getElementById('confirmpswd');
        ...
        if(con_pswd.value === null || con_pswd.value === ''){
            alert("Please Re-enter your password, it should not be empty");            
            return false;
        }
        if(U_pswd.value !== con_pswd.value){
            alert("Passwords doesn't match! Please Re-enter your password.");
            return false;
        }
    ...
    <center>
    <form id='signupform'>        
        <h3><input type='text' placeholder='Username' id='username' autoFocus size='22%'></input></h3>
        ...
        <h3><input type='password' placeholder='Confirm Password' id='confirmpswd' maxLength='8' ></input></h3>  
        ...
        <input type='button' value='SIGN UP' onClick={validateform} style={{ backgroundColor: 'rgb(43, 99, 78)', color:'white'}}/>
    </form>   
    </center> 
    <br/>
    <center>Already have an account?<span style={{color:'rgb(43, 99, 78)', fontWeight:'1000'}} onClick={signup}> Login here</span> </center>
    </div>
    <br/>
    </>
)
